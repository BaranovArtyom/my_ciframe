		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						<h2 class="title"><a href='/PHP_MVC_/news/<?php echo $newsItem['id'] ;?>'><?php echo $newsItem['title'].' # '.$newsItem['id'];?></a></h2>
						<p class="by_create"><?= $newsItem['date'];?></p>
						<a href='/PHP_MVC_/news/<?php echo $newsItem['id'] ;?>' class="permalink"> Full article</a></p>
						<div class="entry">
